...
First Prototype build using the MiniX-Faketec board, "Mighty Tiny" is a fully featured upgraded variant of the bumblebee, everything working perfectly, cant wait to publish the design once I tweaked a few more things to make it more "build friendly"  ;) 
